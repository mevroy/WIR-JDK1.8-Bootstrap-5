	...
	<div class="row">
		<div>
			<img class="col-xs-12 col-lg-offset-3 col-lg-6" id="imager"
				src="/app/00622239-f2b3-48e7-a55a-d7c1f65d05ad/batch/files/ErinInvite.png">
		...
		<div class="col-xs-12 col-lg-offset-3 col-lg-6">
			<div class="panel-group" id="accordion" role="tablist"
				...
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color: #F9C5B3;">
	...
	$(document)
			.ready(
					function() {
						...
						$("#imager")
								.load(
										'/app/00622239-f2b3-48e7-a55a-d7c1f65d05ad/batch/files/ErinInvite.png',
