...
<form id="groupEventInvite" name="groupEventInvite">
			...
			<h2>Create Group Event Invite SMS</h2>
			<br />
				...
				<div class="control-group" id="memberCategoryCodeCtl">
					...
					<div class="controls">
						...
						<select name="memberCategoryCode" class="input-large"
							...
							onchange="loadDiv(); buildGroupEventsOptionsByMemberCategory(this.value, 'groupEventCode'); buildGroupSMSTemplateOptionsByEventCode('NULL','templateName');">
				...
				<div class="control-group" id="groupEventCodeCtl">
					...
					<div class="controls">
						...
						<select name="groupEventCode" class="input-large"
							id="groupEventCode"
							onchange="loadDiv(); buildGroupSMSTemplateOptionsByEventCode(this.value,'templateName'); loadGrid('grid',$('select#memberCategoryCode option').filter(':selected').val(),this.value,'Invite List');">
							<option value="">Select One</option>
						</select>
					</div>
				</div>
			...
			<div class="span2">
				<div class="control-group" id="templateNameCtl">
					<label class="control-label" for="templateName">SMS Date
						</label>

					<div class="input-daterange input-group" id="datepicker">

									<input type="text" name="inviteStartDate" 
										class="input-small input-append form_datetime"
										id="inviteStartDate" placeholder="SMS Date" />&nbsp;<span class="input-prepend add-on"><i
...
var gridDiv = "";
    $(document).ready(function () {
        ...
        sendData = function(data,templateName,groupEventCode,memberCategoryCode,selector, inviteStartDate) {
            var dataToSend = JSON.stringify(data);
            toggleButtonWithId(selector);
            $.ajax({
                type: "POST",
                url: "json/saveGroupEventInviteSMS?templateName="+templateName+"&groupEventCode="+groupEventCode+"&memberCategoryCode="+memberCategoryCode+"&inviteStartDate="+inviteStartDate,
                //dataType:"json",
                data: dataToSend,
                ...
                success: function(response, textStatus, jqXHR) {
                    ...
                    loadMessageModal("Message", response);
                  	loadDiv();
                    loadGrid('grid',memberCategoryCode,groupEventCode,'Invite List');
	...
	$(function() {
        ...
        $("#sendAll").click(function(){
           ...
           if(selectedEmailTemplate==='')
           {
            ...
            sendData(localGridData,selectedEmailTemplate,selectedgroupEventCode,selectedMemberCategoryCode,'sendAll',inviteStartDate);
        ...
        $("#sendSelected").click(function(){
            ...
            sendData(dataToSend,selectedEmailTemplate,selectedgroupEventCode,selectedMemberCategoryCode,'sendSelected',inviteStartDate);
		...
		buildGroupSMSTemplateOptionsByEventCode("NULL",'templateName');
	});
