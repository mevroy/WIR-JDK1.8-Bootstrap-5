...
(function ($) {
    $.widget("ui.combify", {
        ...
        _create: function () {
            ...
            select.before('<div class="controls">' +
                '<span class="ui-combobox">' +
                '<input type="hidden" class="insertedInput" id="' + id + '" name="' + name + '" value="' + selectedValue + '">' +
               // '<input type="text" style="display:none;" role="textbox" class="editable insertedInput" id="' + id + '" name="' + name + '" value="' + selectedValue + '">' +
                '<input type="text" id="' + textInputId + '" class="ui-combobox-input" value="' + selectedText + '">' +
               '<a class="ui-combobox-toggle">'+
            ...
            //Had to comment below becaue had to chage teh image for the toggle
//            button.button({
//                icons: {
...
//            });
            ...
            button.click(function (event) {
                ...
                if($(textInputSelector).autocomplete("widget").is(":visible")){
                 $(textInputSelector).autocomplete('close');}
                else {
                $(textInputSelector).autocomplete('search','');}
